<?php
	...
	$sql = ("SELECT * FROM category, maincategory WHERE category.id_mainCategory = maincategory.id_mainCategory and maincategory.name_mainCategory = 'Полиграфия'");
	$query = $pdo->prepare($sql);
	$query->execute();
	dbCheckError($query);
	$polygraphy = $query->fetchAll();
?>
    ...
    <body>
        <div class="wrapper">
            ...
            <main class="pageCategory">
				<div class="mt9"></div>
				<?php foreach ($polygraphy as $key => $category): ?>
